...
- [x] Rebase onto exact-current `origin/main` `a372df380d529a66d1ca4a2d8abd2e7d0ef3be36`, preserving the merged Ollama adapter alongside Hermes and Codex. Post-rebase focused runtime/HTTP verification passes 104/104; root lint, typecheck, build, and diff check pass. Full orchestrator verification is 4,815/4,818 with only the three established unrelated network-health/CLI order-sensitive failures.

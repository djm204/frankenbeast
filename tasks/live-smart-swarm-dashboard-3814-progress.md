...
- [ ] Run the real GitHub @codex review loop to exact-head clean with zero unresolved threads; round-four's five findings are fixed locally under RED→GREEN and focused coverage is 36/36.

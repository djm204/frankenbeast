...
- [x] Add regression coverage for the four current-head Codex P2 findings.
- [x] Implement fixes in `packages/franken-brain/src/sqlite-brain.ts`.
- [x] Run targeted franken-brain verification.
  - [x] `npm run test --workspace @franken/brain -- tests/unit/sqlite-brain.test.ts` (138 passed).

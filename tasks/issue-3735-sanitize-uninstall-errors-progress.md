# Issue #3735: sanitize fbeast-uninstall errors

- [x] Read the live issue, PM/root handoffs, repository instructions, and shared lessons.
- [x] Verify no existing PR ownership and start from exact current `origin/main`.
- [x] Reproduce the raw uninstall error disclosure and identify the root cause.
- [x] Add a focused failing regression test before production changes.

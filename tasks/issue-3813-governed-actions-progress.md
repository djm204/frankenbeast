...
- [ ] Commit with David Mendez <me@davidmendez.dev>, push, and open one PR linked to #3813 without merging.
- [ ] Run the real GitHub `@codex review` loop to a clean exact-current-head result, green CI, and zero unresolved Codex threads.

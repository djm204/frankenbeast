...
- [x] RED→GREEN: address Codex findings for bounded newest-page polling plus historical backfill, throttled churn refreshes, recoverable errors, REST/SSE races, missing resources, chronological trend continuity, and SSE lifecycle cleanup.

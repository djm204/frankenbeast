...
- [x] Run package tests/typecheck/lint/build and targeted regressions.
  - Targeted rerun after latest fixes: `@franken/brain` memory-access-audit test passed (19 tests); `@franken/orchestrator` memory-snapshot-diff test passed (32 tests).
...
- [x] Push branch and verify CI.
  - Pushed `7d684f17`; CI verification pending live GitHub checks.
- [x] Reply to and resolve Codex threads with concrete evidence.
  - Replied to and resolved Codex comments 3593571502, 3593571509, 3593571517, 3593571523, 3593571530.
- [ ] Trigger fresh @codex review within invocation cap and wait for current-head clean.
  - Triggered with approved cap override at `2026-07-16T08:07:09Z`.

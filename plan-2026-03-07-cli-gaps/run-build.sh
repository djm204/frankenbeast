...
# ── Frankenbeast CLI Gaps Marathon Runner ──
#
# Usage:
...
#   - Feature-level branching (6 features, each gets its own branch)
...
echo ""
echo "╔══════════════════════════════════════════════════════╗"
echo "║  Frankenbeast CLI Gaps Marathon                      ║"
echo "║  Plan: plan-2026-03-07-cli-gaps/                     ║"
echo "║  Features: 6 | Chunks: 12                           ║"
echo "╚══════════════════════════════════════════════════════╝"
echo ""

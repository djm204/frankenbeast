...
export class AlwaysOnSampler implements SamplerStrategy {
 ...
 */
export class ProbabilisticSampler implements SamplerStrategy {
 ...
 * ```
 */
export class RateLimitedSampler implements SamplerStrategy {
 ...
 * ```
 */
export class SamplingAdapter implements ExportAdapter {
  private readonly strategy: SamplerStrategy

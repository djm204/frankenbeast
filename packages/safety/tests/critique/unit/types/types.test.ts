...
import type { Severity, Verdict, Score, SessionId, TaskId } from '../../../../src/critique/types/common.js';
import type {
  EvaluationInput,
  EvaluationFinding,
  EvaluationResult,
  CritiqueResult,
  Evaluator,
} from '../../../../src/critique/types/evaluation.js';
import type {
  SafetyRule,
  SandboxResult,
  CritiqueLesson,
  ...
  ObservabilityPort,
  EscalationPort,
} from '../../../../src/critique/types/contracts.js';
import type {
  LoopConfig,
  CritiqueIteration,
  CorrectionRequest,
...
} from '../../../../src/critique/types/loop.js';

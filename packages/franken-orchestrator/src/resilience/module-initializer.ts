 ...
 */
export async function checkModuleHealth(deps: BeastLoopDeps): Promise<readonly ModuleHealth[]> {
  const checks: ModuleHealth[] = [];
...
export function allHealthy(results: readonly ModuleHealth[]): boolean {

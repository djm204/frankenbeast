export const BEAST_SQLITE_SCHEMA_STATEMENTS = [
  ...
  `CREATE INDEX IF NOT EXISTS idx_beast_run_attempts_started_julianday_run_id
    ON beast_run_attempts(julianday(started_at), run_id) WHERE started_at IS NOT NULL`,

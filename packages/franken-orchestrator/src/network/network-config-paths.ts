const NETWORK_CONFIG_PATH_DEFINITIONS = {
  ...
  'network.egressPolicy.lanes.provider.allowedDestinationClasses': { type: 'json' },
  'network.egressPolicy.lanes.provider.allowedDomains': { type: 'json' },
  'network.egressPolicy.lanes.provider.allowedMethods': { type: 'json' },
  ...
  'comms.slack.allowSensitiveDelivery': { type: 'boolean' },
  ...
  'comms.discord.allowSensitiveDelivery': { type: 'boolean' },
  ...
  'comms.telegram.allowSensitiveDelivery': { type: 'boolean' },
  ...
  'comms.whatsapp.allowSensitiveDelivery': { type: 'boolean' },

...
# Optional — force production chat traffic to same-origin /v1/chat/* when the
# dashboard is deployed behind an orchestrator/BFF/proxy that injects auth.
VITE_CHAT_SAME_ORIGIN=true

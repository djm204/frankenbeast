...
Open the Vite URL, usually `http://127.0.0.1:5173/`. The `dev:chat` script proxies `/api` and `/v1` requests to `https://127.0.0.1:3737` by default.
...
VITE_API_URL=https://localhost:3737

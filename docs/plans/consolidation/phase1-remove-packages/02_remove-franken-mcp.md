...
Replace this with:
```typescript
// Phase 5 placeholder — SkillManager replaces MCP module with marketplace-first skill loading
...
- **Modify:** `packages/franken-orchestrator/src/cli/dep-factory.ts` — remove dynamic import, leave a phase placeholder

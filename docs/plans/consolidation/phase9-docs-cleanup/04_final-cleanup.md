...
```bash
# Search for Phase 1 deferred-work markers
grep -r "Phase 1" packages/ | grep -i "deferred\|follow-up\|stub"
grep -r "consolidation" packages/ | grep -i "deferred\|follow-up\|stub"
